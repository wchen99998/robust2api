...
func (h *GatewayHandler) Messages(c *gin.Context) {
	...
	if isMaxTokensOneHaikuRequest(reqModel, parsedReq.MaxTokens, reqStream) {
		ctx := requestmeta.WithIsMaxTokensOneHaikuRequest(c.Request.Context(), true)
		c.Request = c.Request.WithContext(ctx)
	}
	...
	c.Request = c.Request.WithContext(requestmeta.WithThinkingEnabled(c.Request.Context(), parsedReq.ThinkingEnabled))
