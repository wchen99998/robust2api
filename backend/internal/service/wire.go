...
var SharedProviderSet = wire.NewSet(
	...
	NewAntigravityConnectionTester,
	...
	wire.Bind(new(ControlSessionAuthService), new(*ControlAuthService)),
	wire.Bind(new(ControlLocalCredentialService), new(*ControlAuthService)),
	wire.Bind(new(ControlRegistrationService), new(*ControlAuthService)),
	wire.Bind(new(ControlProfileService), new(*ControlAuthService)),
	wire.Bind(new(ControlBrowserAuthService), new(*ControlAuthService)),
	wire.Bind(new(ControlAccessTokenAuthenticator), new(*ControlAuthService)),
	wire.Bind(new(ControlLocalMFAService), new(*TotpService)),
	NewCRSSyncService,
