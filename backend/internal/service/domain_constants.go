...
import "github.com/wchen99998/robust2api/internal/domain"
...
// OIDCConnectSyntheticEmailDomain 是通用 OIDC 用户的合成邮箱后缀（RFC 保留域名）。
...
const (
	...
	SettingKeyGrafanaURL                  = "grafana_url"                   // Grafana 仪表盘 URL（用于公开配置注入与 iframe CSP）
