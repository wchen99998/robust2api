...
func initialize(buildInfo BuildInfo) (*Application, error) {
	...
	authHandler := handler.NewAuthHandler(configConfig, authService, controlAuthService, userService, settingService, promoService, redeemService, totpService, serviceBuildInfo)
