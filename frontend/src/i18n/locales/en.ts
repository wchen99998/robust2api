export default {
  ...
  home: {
    ...
    heroDesc: 'Pool upstream AI accounts behind one gateway. Automatic failover, load balancing, and usage metering.',
  ...
  onboarding: {
    ...
    admin: {
      ...
      createGroup: {
        ...
        description: '<div class="tour-step-description"><p>Let\'s create your first group.</p><p class="tour-info-box"><b>📝 Tip:</b> Recommend creating a test group first to familiarize yourself with the process</p><p class="tour-cta">👉 Click the "Create Group" button</p></div>'
      },
      groupName: {
        title: '✏️ 1. Group Name',
        description: '<div class="tour-step-description"><p>Give your group an easy-to-identify name.</p><div class="tour-success-box"><b>💡 Naming Suggestions:</b><ul><li>"Test Group" - For testing</li><li>"VIP Premium" - High-quality service</li><li>"Free Trial" - Trial version</li></ul></div><p class="tour-muted">Click "Next" when done</p></div>',
        nextBtn: 'Next'
      },
      groupPlatform: {
        title: '🤖 2. Select Platform',
        description: '<div class="tour-step-description"><p>Choose the AI platform this group supports.</p><div class="tour-info-box"><b>📌 Platform Guide:</b><ul><li><b>Anthropic</b> - Claude models</li><li><b>OpenAI</b> - GPT models</li><li><b>Google</b> - Gemini models</li></ul></div><p class="tour-muted">One group can only have one platform</p></div>',
        nextBtn: 'Next'
      },
      groupMultiplier: {
        title: '💰 3. Rate Multiplier',
        description: '<div class="tour-step-description"><p>Set the billing multiplier to control user charges.</p><div class="tour-warning-box"><b>⚙️ Billing Rules:</b><ul><li><b>1.0</b> - Original price (cost price)</li><li><b>1.5</b> - User consumes $1, charged $1.5</li><li><b>2.0</b> - User consumes $1, charged $2</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p class="tour-muted">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
      ...
      groupSubmit: {
        title: '✅ Save Group',
        description: '<div class="tour-step-description"><p>Confirm the information and click create to save the group.</p><p class="tour-warning-box"><b>⚠️ Note:</b> Platform type cannot be changed after creation, but other settings can be edited anytime</p><p class="tour-success-box"><b>📌 Next Step:</b> After creation, we\'ll add upstream accounts to this group</p><p class="tour-cta">👉 Click "Create" button</p></div>'
      },
      accountManage: {
        title: '🔗 Step 2: Add Account',
        description: '<div class="tour-step-description"><p><b>Great! Group created successfully 🎉</b></p><p>Now add upstream AI service accounts to enable actual service delivery.</p><div class="tour-info-box"><b>🔑 Account Purpose:</b><ul><li>Connect to upstream AI services (Claude, GPT, etc.)</li><li>One group can contain multiple accounts (load balancing)</li><li>Supports OAuth and Session Key methods</li></ul></div><p class="tour-cta">👉 Click "Account Management" on the left sidebar</p></div>'
      },
      createAccount: {
        title: '➕ Add New Account',
        description: '<div class="tour-step-description"><p>Click the button to start adding your first upstream account.</p><p class="tour-success-box"><b>💡 Tip:</b> Recommend using OAuth method - more secure and no manual key extraction needed</p><p class="tour-cta">👉 Click "Add Account" button</p></div>'
      },
      accountName: {
      ...
      accountPlatform: {
        title: '🤖 2. Select Platform',
        description: '<div class="tour-step-description"><p>Choose the service provider platform for this account.</p><p class="tour-warning-box"><b>⚠️ Important:</b> Platform must match the group you just created</p></div>',
        nextBtn: 'Next'
      },
      accountType: {
      ...
      accountGroups: {
        ...
        description: '<div class="tour-step-description"><p><b>Key Step!</b> Assign the account to the group you just created.</p><div class="tour-error-box"><b>⚠️ Important Reminder:</b><ul><li>Must select at least one group</li><li>Unassigned accounts cannot be used</li><li>One account can be assigned to multiple groups</li></ul></div><p class="tour-success-box"><b>💡 Tip:</b> Select the test group you just created</p></div>',
        nextBtn: 'Next'
      },
      accountSubmit: {
        title: '✅ Save Account',
        description: '<div class="tour-step-description"><p>Confirm the information and click save.</p><div class="tour-info-box"><b>📌 OAuth Flow:</b><ul><li>Will redirect to service provider page after clicking save</li><li>Complete login and authorization on provider page</li><li>Auto-return after successful authorization</li></ul></div><p class="tour-success-box"><b>📌 Next Step:</b> After adding account, we\'ll create an API key</p><p class="tour-cta">👉 Click "Save" button</p></div>'
      },
      keyManage: {
        title: '🔑 Step 3: Generate Key',
        description: '<div class="tour-step-description"><p><b>Congratulations! Account setup complete 🎉</b></p><p>Final step: generate an API Key to test if the service works properly.</p><div class="tour-info-box"><b>🔑 API Key Purpose:</b><ul><li>Credential for calling AI services</li><li>Each key is bound to one group</li><li>Can set quota and expiration</li><li>Supports independent usage statistics</li></ul></div><p class="tour-cta">👉 Click "API Keys" on the left sidebar</p></div>'
      },
      createKey: {
        title: '➕ Create Key',
        description: '<div class="tour-step-description"><p>Click the button to create your first API Key.</p><p class="tour-success-box"><b>💡 Tip:</b> Copy and save immediately after creation - key is only shown once</p><p class="tour-cta">👉 Click "Create Key" button</p></div>'
      },
      keyName: {
        title: '✏️ 1. Key Name',
      ...
      keySubmit: {
        ...
        description: '<div class="tour-step-description"><p>System will generate a complete API Key after clicking create.</p><div class="tour-error-box"><b>⚠️ Important Reminder:</b><ul><li>Key is only shown once, copy immediately</li><li>Need to regenerate if lost</li><li>Keep it safe, don\'t share with others</li></ul></div><div class="tour-success-box"><b>🚀 Next Steps:</b><ul><li>Copy the generated sk-xxx key</li><li>Use in any OpenAI-compatible client</li><li>Start experiencing AI services!</li></ul></div><p class="tour-cta">👉 Click "Create" button</p></div>'
      }
    },
    // User tour steps
    user: {
      welcome: {
        title: '👋 Welcome to Sub2API',
        description: '<div class="tour-step-description"><p>Hello! Welcome to the Sub2API AI service platform.</p><p><b>🎯 Quick Start:</b></p><ul><li>🔑 Create API Key</li><li>📋 Copy key to your application</li><li>🚀 Start using AI services</li></ul><p class="tour-cta">Just 1 minute, let\'s get started →</p></div>',
        nextBtn: 'Start 🚀',
        prevBtn: 'Skip'
      },
      keyManage: {
        title: '🔑 API Key Management',
        description: '<div class="tour-step-description"><p>Manage all your API access keys here.</p><p class="tour-info-box"><b>📌 What is an API Key?</b><br/>An API key is your credential for accessing AI services, like a key that allows your application to call AI capabilities.</p><p class="tour-cta">👉 Click to enter key page</p></div>'
      },
      createKey: {
        title: '➕ Create New Key',
        description: '<div class="tour-step-description"><p>Click the button to create your first API key.</p><p class="tour-success-box"><b>💡 Tip:</b> Key is only shown once after creation, make sure to copy and save</p><p class="tour-cta">👉 Click "Create Key"</p></div>'
      },
      keyName: {
        title: '✏️ Key Name',
      ...
      keySubmit: {
        ...
        description: '<div class="tour-step-description"><p>Click to confirm and create your API key.</p><div class="tour-error-box"><b>⚠️ Important:</b><ul><li>Copy the key (sk-xxx) immediately after creation</li><li>Key is only shown once, need to regenerate if lost</li></ul></div><p class="tour-success-box"><b>🚀 How to Use:</b><br/>Configure the key in any OpenAI-compatible client (like ChatBox, OpenCat, etc.) and start using!</p><p class="tour-cta">👉 Click "Create" button</p></div>'
      }
    }
  },
