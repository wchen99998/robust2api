export default {
  ...
  auth: {
    ...
    passwordLoginDisabled: '当前部署已禁用邮箱密码登录，请使用第三方登录。',
    noSignInMethods: '当前没有可用的登录方式，请联系管理员。',
    ...
    emailVerificationDisabled: '邮箱验证不可用',
    emailVerificationManagedExternally: '当前部署使用外部身份提供商处理验证流程。',
    ...
    forgotPasswordDisabled: '密码重置不可用',
    passwordResetManagedExternally: '密码重置由身份提供商管理，请使用提供商的重置流程。',
    showPassword: '显示密码',
    hidePassword: '隐藏密码',
