export default {
  ...
  home: {
    ...
    heroDesc: '将上游 AI 账号整合到一个网关。自动故障转移、负载均衡和用量计费。',
    documentation: '查看文档',
    metrics: {
      autoscaling: 'K8s 弹性伸缩',
      sla: '99.9% SLA',
      deploys: '零停机部署',
    },
    footer: {
  ...
  onboarding: {
    ...
    admin: {
      welcome: {
        title: '👋 欢迎使用 Sub2API',
        description:
          '<div class="tour-step-description"><p>Sub2API 是一个强大的 AI 服务中转平台，让您轻松管理和分发 AI 服务。</p><p><b>🎯 核心功能：</b></p><ul><li>📦 <b>分组管理</b> - 创建不同的服务套餐（VIP、免费试用等）</li><li>🔗 <b>账号池</b> - 连接多个上游 AI 服务商账号</li><li>🔑 <b>密钥分发</b> - 为用户生成独立的 API Key</li><li>💰 <b>计费管理</b> - 灵活的费率和配额控制</li></ul><p class="tour-cta">接下来，我们将用 3 分钟带您完成首次配置 →</p></div>',
        nextBtn: '开始配置 🚀',
        prevBtn: '跳过'
      },
      groupManage: {
        title: '📦 第一步：分组管理',
        description:
          '<div class="tour-step-description"><p><b>什么是分组？</b></p><p>分组是 Sub2API 的核心概念，它就像一个"服务套餐"：</p><ul><li>🎯 每个分组可以包含多个上游账号</li><li>💰 每个分组有独立的计费倍率</li><li>👥 可以设置为公开或专属分组</li></ul><p class="tour-success-box"><b>💡 示例：</b>您可以创建"VIP专线"（高倍率）和"免费试用"（低倍率）两个分组</p><p class="tour-cta">👉 点击左侧的"分组管理"开始</p></div>'
      },
      createGroup: {
        title: '➕ 创建新分组',
        description:
          '<div class="tour-step-description"><p>现在让我们创建第一个分组。</p><p class="tour-info-box"><b>📝 提示：</b>建议先创建一个测试分组，熟悉流程后再创建正式分组</p><p class="tour-cta">👉 点击"创建分组"按钮</p></div>'
      },
      groupName: {
        title: '✏️ 1. 分组名称',
        description:
          '<div class="tour-step-description"><p>为您的分组起一个易于识别的名称。</p><div class="tour-success-box"><b>💡 命名建议：</b><ul><li>"测试分组" - 用于测试</li><li>"VIP专线" - 高质量服务</li><li>"免费试用" - 体验版</li></ul></div><p class="tour-muted">填写完成后点击"下一步"继续</p></div>',
        nextBtn: '下一步'
      },
      groupPlatform: {
        title: '🤖 2. 选择平台',
        description:
          '<div class="tour-step-description"><p>选择该分组支持的 AI 平台。</p><div class="tour-info-box"><b>📌 平台说明：</b><ul><li><b>Anthropic</b> - Claude 系列模型</li><li><b>OpenAI</b> - GPT 系列模型</li><li><b>Google</b> - Gemini 系列模型</li></ul></div><p class="tour-muted">一个分组只能选择一个平台</p></div>',
        nextBtn: '下一步'
      },
      groupMultiplier: {
        title: '💰 3. 费率倍数',
        description:
          '<div class="tour-step-description"><p>设置该分组的计费倍率，控制用户的实际扣费。</p><div class="tour-warning-box"><b>⚙️ 计费规则：</b><ul><li><b>1.0</b> - 原价计费（成本价）</li><li><b>1.5</b> - 用户消耗 $1，扣除 $1.5</li><li><b>2.0</b> - 用户消耗 $1，扣除 $2</li><li><b>0.8</b> - 补贴模式（亏本运营）</li></ul></div><p class="tour-muted">建议测试分组设置为 1.0</p></div>',
        nextBtn: '下一步'
      },
      groupExclusive: {
        title: '🔒 4. 专属分组（可选）',
      ...
      groupSubmit: {
        title: '✅ 保存分组',
        description:
          '<div class="tour-step-description"><p>确认信息无误后，点击创建按钮保存分组。</p><p class="tour-warning-box"><b>⚠️ 注意：</b>分组创建后，平台类型不可修改，其他信息可以随时编辑</p><p class="tour-success-box"><b>📌 下一步：</b>创建成功后，我们将添加上游账号到这个分组</p><p class="tour-cta">👉 点击"创建"按钮</p></div>'
      },
      accountManage: {
        title: '🔗 第二步：添加账号',
        description:
          '<div class="tour-step-description"><p><b>太棒了！分组已创建成功 🎉</b></p><p>现在需要添加上游 AI 服务商的账号，让分组能够实际提供服务。</p><div class="tour-info-box"><b>🔑 账号的作用：</b><ul><li>连接到上游 AI 服务（Claude、GPT 等）</li><li>一个分组可以包含多个账号（负载均衡）</li><li>支持 OAuth 和 Session Key 两种方式</li></ul></div><p class="tour-cta">👉 点击左侧的"账号管理"</p></div>'
      },
      createAccount: {
        title: '➕ 添加新账号',
        description:
          '<div class="tour-step-description"><p>点击按钮开始添加您的第一个上游账号。</p><p class="tour-success-box"><b>💡 提示：</b>建议使用 OAuth 方式，更安全且无需手动提取密钥</p><p class="tour-cta">👉 点击"添加账号"按钮</p></div>'
      },
      accountName: {
        title: '✏️ 1. 账号名称',
        description:
      ...
      accountPlatform: {
        title: '🤖 2. 选择平台',
        description:
          '<div class="tour-step-description"><p>选择该账号对应的服务商平台。</p><p class="tour-warning-box"><b>⚠️ 重要：</b>平台必须与刚才创建的分组平台一致</p></div>',
        nextBtn: '下一步'
      },
      accountType: {
        title: '🔐 3. 授权方式',
      ...
      accountGroups: {
        title: '🎯 5. 分配分组',
        description:
          '<div class="tour-step-description"><p><b>关键步骤！</b>将账号分配到刚才创建的分组。</p><div class="tour-error-box"><b>⚠️ 重要提醒：</b><ul><li>必须勾选至少一个分组</li><li>未分配分组的账号无法使用</li><li>一个账号可以分配给多个分组</li></ul></div><p class="tour-success-box"><b>💡 提示：</b>请勾选刚才创建的测试分组</p></div>',
        nextBtn: '下一步'
      },
      accountSubmit: {
        title: '✅ 保存账号',
        description:
          '<div class="tour-step-description"><p>确认信息无误后，点击保存按钮。</p><div class="tour-info-box"><b>📌 OAuth 授权流程：</b><ul><li>点击保存后会跳转到服务商页面</li><li>在服务商页面完成登录授权</li><li>授权成功后自动返回</li></ul></div><p class="tour-success-box"><b>📌 下一步：</b>账号添加成功后，我们将创建 API 密钥</p><p class="tour-cta">👉 点击"保存"按钮</p></div>'
      },
      keyManage: {
        title: '🔑 第三步：生成密钥',
        description:
          '<div class="tour-step-description"><p><b>恭喜！账号配置完成 🎉</b></p><p>最后一步，生成 API Key 来测试服务是否正常工作。</p><div class="tour-info-box"><b>🔑 API Key 的作用：</b><ul><li>用于调用 AI 服务的凭证</li><li>每个 Key 绑定一个分组</li><li>可以设置配额和有效期</li><li>支持独立的使用统计</li></ul></div><p class="tour-cta">👉 点击左侧的"API 密钥"</p></div>'
      },
      createKey: {
        title: '➕ 创建密钥',
        description:
          '<div class="tour-step-description"><p>点击按钮创建您的第一个 API Key。</p><p class="tour-success-box"><b>💡 提示：</b>创建后请立即复制保存，密钥只显示一次</p><p class="tour-cta">👉 点击"创建密钥"按钮</p></div>'
      },
      keyName: {
        title: '✏️ 1. 密钥名称',
        description:
      ...
      keySubmit: {
        title: '🎉 生成并复制',
        description:
          '<div class="tour-step-description"><p>点击创建后，系统会生成完整的 API Key。</p><div class="tour-error-box"><b>⚠️ 重要提醒：</b><ul><li>密钥只显示一次，请立即复制</li><li>丢失后需要重新生成</li><li>妥善保管，不要泄露给他人</li></ul></div><div class="tour-success-box"><b>🚀 下一步：</b><ul><li>复制生成的 sk-xxx 密钥</li><li>在支持 OpenAI 接口的客户端中使用</li><li>开始体验 AI 服务！</li></ul></div><p class="tour-cta">👉 点击"创建"按钮</p></div>'
      }
    },
    // User tour steps
    user: {
      welcome: {
        title: '👋 欢迎使用 Sub2API',
        description:
          '<div class="tour-step-description"><p>您好！欢迎来到 Sub2API AI 服务平台。</p><p><b>🎯 快速开始：</b></p><ul><li>🔑 创建 API 密钥</li><li>📋 复制密钥到您的应用</li><li>🚀 开始使用 AI 服务</li></ul><p class="tour-cta">只需 1 分钟，让我们开始吧 →</p></div>',
        nextBtn: '开始 🚀',
        prevBtn: '跳过'
      },
      keyManage: {
        title: '🔑 API 密钥管理',
        description:
          '<div class="tour-step-description"><p>在这里管理您的所有 API 访问密钥。</p><p class="tour-info-box"><b>📌 什么是 API 密钥？</b><br/>API 密钥是您访问 AI 服务的凭证，就像一把钥匙，让您的应用能够调用 AI 能力。</p><p class="tour-cta">👉 点击进入密钥页面</p></div>'
      },
      createKey: {
        title: '➕ 创建新密钥',
        description:
          '<div class="tour-step-description"><p>点击按钮创建您的第一个 API 密钥。</p><p class="tour-success-box"><b>💡 提示：</b>创建后密钥只显示一次，请务必复制保存</p><p class="tour-cta">👉 点击"创建密钥"</p></div>'
      },
      keyName: {
        title: '✏️ 密钥名称',
        description:
      ...
      keySubmit: {
        title: '🎉 完成创建',
        description:
          '<div class="tour-step-description"><p>点击确认创建您的 API 密钥。</p><div class="tour-error-box"><b>⚠️ 重要：</b><ul><li>创建后请立即复制密钥（sk-xxx）</li><li>密钥只显示一次，丢失需重新生成</li></ul></div><p class="tour-success-box"><b>🚀 如何使用：</b><br/>将密钥配置到支持 OpenAI 接口的任何客户端（如 ChatBox、OpenCat 等），即可开始使用！</p><p class="tour-cta">👉 点击"创建"按钮</p></div>'
      }
    }
  },
